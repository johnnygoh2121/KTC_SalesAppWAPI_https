...
namespace KTC_SalesAppWAPI.Models.Cdn
{
     public class ORIN
     {
        ...
        public int U_SOENTRY { get; set; }
        public List<RIN1> Lines { get; set; }
        public PafApproval Approval { get; set; }
        public string SubSi { get; set; }
        public string SubSiID { get; set; }

        public string OwnerCode_ { get; set; } // seller code 
        public string OwnerName { get; set; } // seller name 

        public string Remarks { get; set; } // RTN remarks 

        // server message 
        public string SvrMsg { get; set; }


        #region fields for table ORIN
        public int DocEntry { get; set; }
         ...
         public string U_M_Payment { get; set; }
         public string U_DeliveryLeadTime { get; set; }
         public string U_Validity { get; set; }
         public string U_Delivery { get; set; }
         public string U_Area { get; set; }
         public string U_LorryNo { get; set; }
         public string U_State { get; set; }
         public string U_DoNum { get; set; }
         ...
         public string U_GSTDocNo { get; set; }
         public DateTime U_ConfDate { get; set; }
         public string U_OriSO { get; set; }
         public string U_Remarks { get; set; }
         public string U_SSTCert { get; set; }
         public string U_SSTCardC { get; set; }
        public int U_GRPRD { get; set; } = 7;

        public long U_CSUS_PAF { get; set; } // for checking instance create of CN

       
        #endregion fields for table ORIN
    }
}
