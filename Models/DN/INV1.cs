...
namespace KTC_SalesAppWAPI.Models.DN
{
    public class INV1
    {
        //public string BatchNum { get; set; } // for return invoice 

        public List<Batch> Batches { get; set; }
        public string ManBtchNum { get; set; } = "N";
        public Guid LineGuid { get; set; } // for whs return 

        // for invoice return properties 
        ...
        public string Text { get; set; } // as sales line remarks 20231028
        ...
        public string U_MItemCode { get; set; }
        public string U_MItemName { get; set; }
        public string U_FOC { get; set; }
        public decimal U_MPrice { get; set; }
        public int U_IENTRY { get; set; }
        public int U_ILINE { get; set; }
        public string U_CNReason { get; set; }
        public string U_RejectReason { get; set; }
        public string U_Model { get; set; }
        public string U_Packaging { get; set; }
        #endregion fields for table INV1
    }
}
